...
void export_actor() {
  ...
  enum_<cr::TrafficLightArrowState::ArrowState>("TrafficLightArrow")
      ...
      .value("GreenUpLeft", cr::TrafficLightArrowState::ArrowState::GreenUpLeft)
      .value("GreenUpRight", cr::TrafficLightArrowState::ArrowState::GreenUpRight)
      .value("GreenDown", cr::TrafficLightArrowState::ArrowState::GreenDown)
      .value("GreenDownLeft", cr::TrafficLightArrowState::ArrowState::GreenDownLeft)
      .value("GreenDownRight", cr::TrafficLightArrowState::ArrowState::GreenDownRight)
      ...
      .value("YellowUpLeft", cr::TrafficLightArrowState::ArrowState::YellowUpLeft)
      .value("YellowUpRight", cr::TrafficLightArrowState::ArrowState::YellowUpRight)
      .value("YellowDown", cr::TrafficLightArrowState::ArrowState::YellowDown)
      .value("YellowDownLeft", cr::TrafficLightArrowState::ArrowState::YellowDownLeft)
      .value("YellowDownRight", cr::TrafficLightArrowState::ArrowState::YellowDownRight)
      ...
      .value("RedUpLeft", cr::TrafficLightArrowState::ArrowState::RedUpLeft)
      .value("RedUpRight", cr::TrafficLightArrowState::ArrowState::RedUpRight)
      .value("RedDown", cr::TrafficLightArrowState::ArrowState::RedDown)
      .value("RedDownLeft", cr::TrafficLightArrowState::ArrowState::RedDownLeft)
      .value("RedDownRight", cr::TrafficLightArrowState::ArrowState::RedDownRight)
      .value("User1", cr::TrafficLightArrowState::ArrowState::User1)
      .value("User2", cr::TrafficLightArrowState::ArrowState::User2)
      .value("User3", cr::TrafficLightArrowState::ArrowState::User3)
      .value("User4", cr::TrafficLightArrowState::ArrowState::User4)
      .value("User5", cr::TrafficLightArrowState::ArrowState::User5)
      .value("User6", cr::TrafficLightArrowState::ArrowState::User6)
      .value("User7", cr::TrafficLightArrowState::ArrowState::User7)
  ;
